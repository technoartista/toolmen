<?php namespace App\Http\Controllers;
	...
	class AdminOrdersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Order Number','name'=>'order_number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','readonly'=>'1'];
			...
			$columns[] = [
				...
				'name'=>'products_id',
				'type'=>'datamodal',
				'datamodal_table'=>'products',
				'datamodal_columns'=>'name,sku,brands_id,categories_id,sell_price,stock',
				'datamodal_select_to'=>'name:products_name,sell_price:products_price,sku:products_sku,brands_id:brands_id,categories_id:categories_id',
			...
			$columns[] = ['label'=>'Product Brand','name'=>'brands_id','type'=>'text','readonly'=>false,'required'=>true];
			$columns[] = ['label'=>'Product Category','name'=>'categories_id','type'=>'text','readonly'=>true,'required'=>true];
			...
			$this->form[] = ['label'=>'Order Detail','name'=>'order_detail','type'=>'child','columns'=>$columns,'width'=>'col-sm-10','table'=>'orders_detail','foreign_key'=>'orders_id'];

			// $this->form[] = ['label'=>'Order Detail','name'=>'order_detail','type'=>'child','width'=>'col-sm-10','table'=>'orders_detail','foreign_key'=>'orders_id'];
			
			$this->form[] = ['label'=>'Total','name'=>'total','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10','readonly'=>'true'];
			$this->form[] = ['label'=>'Tax','name'=>'tax','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
